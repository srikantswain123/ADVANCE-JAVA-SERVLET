...
@WebServlet("/DBReouseServlet")
public class DBReouseServlet extends HttpServlet {
	...
	/*
	 * private Connection getPooledConnection()throws Exception{ InitialContext
	 * ic=null; DataSource ds=null; Connection con=null; //create InitialContext
	 * object ic=new InitialContext(); //get DataSource object ref from Jndi
	 * registry ds=(DataSource) ic.lookup("java:/comp/env/DsJndi"); //get Pooled
	 * jdbc con object con=ds.getConnection(); return con; }//method
	 */
}//class
